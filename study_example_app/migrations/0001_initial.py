    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('a_field', models.CharField(max_length=32)),
            ],
        ),
        migrations.CreateModel(
            name='Bmodel',
        ...
        migrations.CreateModel(
            name='AModelBModelRelation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study_example_app.amodel')),
                ('b', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study_example_app.bmodel')),
            ],
        ),
        migrations.AddField(
            model_name='amodel',
            name='b_set',
            field=models.ManyToManyField(through='study_example_app.AModelBModelRelation', to='study_example_app.Bmodel'),
        ),
    ]
