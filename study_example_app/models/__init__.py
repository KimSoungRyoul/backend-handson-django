...
class ExampleUser(models.Model):
    ...
    aaa = models.CharField(max_length=33, default='aaaa')
    bbb = models.CharField(max_length=34,help_text='나는 주석입니다.')
    ccc = models.CharField(max_length=34,default='ccsdf')
...
class Territory(models.Model):
    location_code = models.CharField(primary_key=True, max_length=32)
...
class Data(models.Model):
    territory = models.OneToOneField('Territory', primary_key=True, db_column='location_code', on_delete=models.CASCADE)
