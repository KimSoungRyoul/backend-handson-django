...
class PythonModel(models.Model):
    str_attr = models.CharField(max_length=32, default="기본값", db_column="str_column")
    ...
    # auto_now_add=True 라는 옵션대신에 default=timezone.now 라는 옵션을 사용해도 같은 동작을한다. 하지만 auto_now_add=True 옵션이 더 간결해 보인다. (django.utils import timezone)
