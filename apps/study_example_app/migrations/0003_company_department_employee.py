        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=32), size=5),
                ),
                (
                    "company",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="study_example_app.company"),
                ),
                (
                    "department",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="study_example_app.department"),
                ),
            ],
        ),
    ]
