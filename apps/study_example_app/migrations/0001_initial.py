...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(max_length=256, null=True, upload_to=study_example_app.models.file_field_example_models.upload_filepath)),
                ('image', models.ImageField(max_length=256, upload_to=study_example_app.models.file_field_example_models.upload_filepath)),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
        ...
        migrations.AddField(
            model_name='menu',
            name='restaurant',
            field=models.ForeignKey(help_text='이 메뉴를 판매하는 음식점', on_delete=django.db.models.deletion.CASCADE, to='study_example_app.restaurant'),
        ),
    ]
