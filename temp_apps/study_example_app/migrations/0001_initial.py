    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        ...
                        help_text="auto_now가 True이면 해당 모델이 .save()될때 마다 최신날짜로 값을 자동으로 갱신해준다.auto_now_add가  True이면 해당모델이 .create()되는 최초1회만 날짜값을 최신날짜를 채워준다.이런 옵션들은 주로 생성날짜, 최근수정날짜를 로깅할때 사용한다.",
                    ),
                ),
                (
                    "datetime_field",
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        max_length=256,
                        null=True,
                        upload_to=study_example_app.models.file_field_example_models.upload_filepath,
                    ),
                ),
                (
                    "image",
                    models.ImageField(
                        max_length=256, upload_to=study_example_app.models.file_field_example_models.upload_filepath
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        help_text="연락처",
                        max_length=32,
                        validators=[django.core.validators.RegexValidator(regex="\\d{2,3}-\\d{3,4}-\\d{4}")],
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="study_example_app.restaurant",
            ),
        ),
    ]
